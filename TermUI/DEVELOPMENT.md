...
Welcome to the development guide for TermUI. Follow these steps to set up your environment.

## Prerequisites
This project utilizes the **Bun** runtime ecosystem. Ensure you have it installed globally.
...
1. Install project dependencies securely:
   ...
   bun install
   ```
2. Run the automated testing suite framework:
   ```bash
   bun test
   ```

## Branching Protocol
Always isolate your features onto clear, distinct git branches before submitting changes.
